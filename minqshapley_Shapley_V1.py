...
class Shapley:
    ...
    def calc_shapleypq(self, p, q, steps, device, probability):
        ...
        pandasframe.to_csv('results/shapley' + self.datatype + '/batched_shapley_values_{}_{}_{:.2f}_specific.csv'.format(self.protein_names[p], self.protein_names[q], probability), index=False)
